...
namespace BlobPreviz
{
    ...
    public class NpcWanderer : MonoBehaviour
    {
        ...
        [Range(0.5f, 10f)] public float walkSpeed = 1.4f;
        ...
        [Header("Speed Variability")]
        [Tooltip("+/- range applied to walkSpeed each time a new waypoint is picked. Set by NpcManager at runtime.")]
        public float speedVariability = 0f;
        ...
        void PickNewTarget()
        {
            ...
            // Each waypoint arrival picks a fresh speed within the variability window.
            float newSpeed = speedVariability > 0f
                ? Mathf.Max(0.1f, walkSpeed + Random.Range(-speedVariability, speedVariability))
                : walkSpeed;
